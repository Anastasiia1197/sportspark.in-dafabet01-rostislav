# sportspark.in
ТЗ sportspark.in dafabet

!!! 
1) всі посилання в head у файлы index.html мають бути https://sportspark.in/ (сайт на якому буде контент). також змінити у sitemap та robots.txt на правильне посилання + дати сьогоднішні 
2) на сторінці /en-in/ контент такий самий, як в index.html АЛЕ: 
   - <html lang="en-IN">
...
4) у фолдері /play/ посилання має бути https://aaavendiro.top/YDPCQ5
5) лого та фавіконя оновлювала для бренду dafabet(візміть з попередніх задач)  
6) у файлі .htaccess нічого писати не потрібно, видаляти також НЕ потрібно 

!!! зверніть увагу: тут інакший шаблон (як в тестовому) 
- в цьому шаблоні зробити 6 img:  1.webp, ...  6.webp (у канві назва 'Rostislav 600x400 пикселей' - це вірні розміри картинок для цього сайту).
...
MT - Dafabet India 🇮🇳 Official Login, App Download & Sports Betting Guide

MD - Dafabet India ⭐ Learn how to use Dafabet login, download the official app or APK, access sports betting and casino games on mobile. Safe, fast and updated guide for Indian players.
...
<H2>Dafabet Official Website vs Mobile Platform</H2>
...
<H3>Dafabet App Login & Features</H3>
...
<H2>Dafabet Alternative Platforms for India</H2>
